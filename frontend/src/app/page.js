...
const EtherealScene = dynamic(() => import("@/components/three/EtherealScene"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-screen bg-gradient-to-br from-black via-blue-950 to-black flex items-center justify-center">
      <div className="text-white text-xl animate-pulse">Loading Digital Etherealism...</div>
    </div>
  ),
});

const GlassControlPanel = dynamic(() => import("@/components/three/GlassControlPanel"), {
  ssr: false,
});
